...
public class alatdanseragam extends javax.swing.JFrame {
   ...
   private void total(){
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 600, 50, 60));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar icon/background.jpg"))); // NOI18N
